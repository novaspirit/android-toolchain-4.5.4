/* Generated automatically by the program 'build/genpreds'
   from the machine description file '/mnt/jenkins/workspace/linaro-android_toolchain-4.5-2011.06-0/build/objdir/temp-src/gcc-linaro-4.5-2011.06-0/gcc/config/arm/arm.md'.  */
